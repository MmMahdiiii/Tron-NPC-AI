...
class Constants(object):
    ...
    def __init__(self, max_cycles=None, init_health=None, wall_breaker_cooldown=None, wall_breaker_duration=None,
                 wall_score_coefficient=None, area_wall_crash_score=None, my_wall_crash_score=None,
                 enemy_wall_crash_score=None):
        self.initialize(max_cycles, init_health, wall_breaker_cooldown, wall_breaker_duration, wall_score_coefficient,
                        area_wall_crash_score, my_wall_crash_score, enemy_wall_crash_score)

    def initialize(self, max_cycles=None, init_health=None, wall_breaker_cooldown=None, wall_breaker_duration=None,
                   wall_score_coefficient=None, area_wall_crash_score=None, my_wall_crash_score=None,
                   enemy_wall_crash_score=None):
...
class Agent(object):
    ...
    def __init__(self, health=None, position=None, direction=None, wall_breaker_cooldown=None,
                 wall_breaker_rem_time=None):
        self.initialize(health, position, direction, wall_breaker_cooldown, wall_breaker_rem_time)

    def initialize(self, health=None, position=None, direction=None, wall_breaker_cooldown=None,
                   wall_breaker_rem_time=None):
        self.health = health
